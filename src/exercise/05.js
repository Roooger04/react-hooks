...
function Tilt({children}) {
  ...
  React.useEffect(() => {
    ...
    // Opcionalmente a função do useEffect pode retornar um função de "limpeza",
    // que remove quaisquer elementos que foram adicionados ao DOM pelo proprio useEffect().
    return () => tiltNode.VanillaTilt.destroy()
  },[ /* Sem dependencias */ ])
